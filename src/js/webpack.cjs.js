...
console.log(require('./webpack.cjs.utils').x)  // 10
// 清除所有 module 緩存
Object.keys(require.cache).forEach(function (key) {
    delete require.cache[key];
})
// 清除 module 緩存後重新加載
console.log(require('./webpack.cjs.utils').x) // 5

// 直接執行( node module.js ): require.main 指向 module 本身。
console.log('require.main is module', require.main === module) // true
// module.parent is null
console.log('require.main is module.parent', require.main === module.parent) // false
