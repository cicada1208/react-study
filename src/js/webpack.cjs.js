...
console.log('module path:', require.resolve('./webpack.cjs.utils')) // /Users/cicadawang/Documents/GitHub/study/src/js/webpack.cjs.utils.js
console.log('entry point of the current application:', require.main.filename) // /Users/cicadawang/Documents/GitHub/study/src/js/webpack.cjs.js
...
// module 可多次 require，但只在第一次加載執行，然後執行結果就被緩存，
// 再次 require，就直接讀取緩存結果。要讓 module 再次加載執行，必須清除緩存。
